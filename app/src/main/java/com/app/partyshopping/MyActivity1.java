    ...
    private void searchItemInItemsNode(String itemId) {
        ...
        flowersRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MyActivity1.this, "Failed to fetch item details: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        stagesDesignRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(MyActivity1.this, "Item with ID " + itemId + " not found in any category", Toast.LENGTH_SHORT).show();
                }
            }
