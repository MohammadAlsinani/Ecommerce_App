...
public class historyUserAdapter extends RecyclerView.Adapter<historyUserAdapter.OrderViewHolder> {
    private List<AdminOrder> orderList;
    private HistoryFragment activity;
    private Context context;


    public historyUserAdapter(List<AdminOrder> orderList, HistoryFragment activity,Context context) {
    ...
    public class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        public OrderViewHolder(@NonNull View itemView) {
            super(itemView);
            nameTextView = itemView.findViewById(R.id.order_item_title);
            dateTimeTextView = itemView.findViewById(R.id.order_item_datetime);
            orderStatusTextView = itemView.findViewById(R.id.item_status);
            viewDetailsTextView = itemView.findViewById(R.id.order_item_price);
        }
